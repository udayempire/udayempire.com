            ...
            <div className="mt-7">
                ...
                <div className="w-full">
                    <div className="max-w-7xl">
                        <div>
                            <h1 className="font-ubuntu text-4xl md:text-5xl w-full text-left text-zinc-200  ">My First Hackathon Experience</h1>
                        ...
                        <div className="p-5 text-lg flex flex-col ">
                            ...
                            <Para text="For the design part, we took heavy inspiration from AI-based tools like Rollout.site (underrated gem, by the way). I kept asking ChatGPT, seniors, and dev friends to poke holes in the idea. Every time I fixed one loophole, the project just got more complex. With just 2 devs, we didn’t have the luxury to over-engineer things.And NO—“vibe coding” doesn't magically solve this. That’s a straight-up myth. We automated a few parts using AI tools (which did save time), but trust me, AI-generated code comes with its own bugs. Only if you’ve coded before can you fix them quickly. " />
                            ...
                            <Para text="We reached Delhi at 4 AM and waited in the station till 6 AM for metros to start. The pollution hit hard. Coming from Bhopal, I was not ready for that air. We reached the hackathon venue by 8 AM. Hospitality was nice. Food was great. Opening ceremony? Meh. Just dragged" />
                            ...
                            <Para text="Mentor round was at 7 AM. Frontend was super laggy due to the Thirdweb template, and the app kept freezing. We had everything built, but couldn’t showcase it well. They didn’t let us explain properly—like they were in a rush to catch a flight.We got 10 out of 15, but it wasn’t enough. We got 10 out of 15, but it wasn’t enough." />
                            ...
                            <ul className="list-decimal px-4 dark:text-zinc-300 text-zinc-600">
                                ...
                                <li>
                                    <span className="font-bold">Don’t over-engineer.</span> Build an MVP. You are not launching a full-blown SaaS in 24 hours.
                                </li>
                                <li>
                                ...
                                <li>
                                    <span className="font-bold">Balance your tech stack.</span> Get devs who understand and can explain things well. We really needed that extra hand.
                                </li>
                                <li>
                            ...
                            <Para className="" text="Hell yes. It was frustrating, tiring, and disappointing.But also exciting, challenging, and packed with learning. I got to know there is a lot to learn I need to learn and grow." />
