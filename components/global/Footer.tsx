        ...
        <footer className="w-full p-5 px-8 border-t mt-10">
            <div className="md:flex items-center justify-between gap-4">
                ...
                <div className="hidden md:flex items-center gap-3">
                    ...
                    <p className="font-light md:text-md">Last Updated 27/01/25</p>
                </div>
                {/* Mobile View */}
                <div className="md:hidden flex gap-3 justify-between items-center">
                    <div className="font-light text-xs">© Made with &#10084; by Uday 2025</div>
                    <div className="flex items-center gap-3">
                        <div className="bg-green-500 animate-pulse rounded-full w-2 h-2"></div>
                        <p className="font-light text-xs">Last Updated 27/01/25</p>
                    </div>
                </div>
            </div>
        </footer>
