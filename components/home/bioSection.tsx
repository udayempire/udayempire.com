  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-20 justify-items-center items-center">
      ...
      <div className="flex flex-col gap-8 items-center md:mt-28">
        ...
        <Slide delay={.2}>
          <ShimmerButton href="https://drive.google.com/file/d/1Qi5g_lyyCgHh8rS4pcmb9-yTQ-ESqPJH/view?usp=drive_link" className="shadow-xl px-10 py-4" borderRadius="10px">
